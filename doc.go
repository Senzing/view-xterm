...
More information at https://github.com/senzing/view-xterm
...
More information can be found in the [pkg/github.com/senzing/view-xterm/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
		...
		"github.com/senzing/view-xterm/examplepackage"
		"github.com/senzing/view-xterm/anotherpackage"
	)
